...
const Saldo = () => {
  ...
  return (
    <div className='h-screen w-screen absolute z-10 '>
      ...
      <div className='bg-white w-[80rem] h-[35rem] right-40 border-2 rounded-lg border-orange-300 shadow-2xl text-center top-20 z-10 absolute overflow-auto scrollbar  scrollbar-thumb-rounded-full scrollbar-thumb-blue-300   scroll-smooth overflow-x-hidden '>
